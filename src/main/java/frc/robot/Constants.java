...
public final class Constants {
     ...
     * public static final double DRIVE_GEAR_RATIO = (50.0 / 16.0) * (16.0 / 28.0) *
     * (45.0 / 15.0);
     ...
     * public static final double ROTATION_VELOCITY = (2 * Math.PI) * 2; // 2
     * complete rotations per second (720 deg/s)
     *
     ...
     * // https://www.chiefdelphi.com/uploads/default/original/3X/d/8/
     * d8c45602d966d596cd37b43017385db0b5a36bc7.pdf
    ...
    public static class Drive {
        public static Drivetrain DRIVETRAIN = TunerConstants.createDrivetrain();

        public static final LinearVelocity MAX_SPEED_MPS = TunerConstants.kSpeedAt12Volts.times(0.95);
        public static final AngularVelocity MAX_ANGULAR_VELOCITY = RotationsPerSecond.of(1.5);
        ...
        public static final double AMP_SLOWDOWN_SCALAR = 0.5;
        public static final Angle AMP_ADJUST_ANGLE = Degrees.of(10);
    ...
    // public static final HashMap<String, Pose2d> POSITIONS = new
    ...
    // public static final HashMap<String, String> CHOREO = new
    // HashMap<>(Map.ofEntries(
    // Map.entry("Test", "testStraightAuto")
    // ));

    // public static final int PATHPLANNER_OFFSET = 200;
    // public static final HashMap<String, String> PATHPLANNER = new
    // HashMap<>(Map.ofEntries(
    // // Add more here
    // ));

    // public static final Pose2d WAIT_UNTIL_POSITION_ERROR = Util.pose(0.25, 0.25,
    // 20.0);
