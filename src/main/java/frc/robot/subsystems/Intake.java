...
public class Intake extends SubsystemBase {
    ...
    /**
     * Returns an initialized class of Intake if one exists, or create a new one if
     * it doesn't (and return it).
     * 
     * @return The intake
     **/
     ...
     * Ground -> intake
     * NOTE: should be used before you are at the note, to ensure you can just run
     * over it and voila it is now yours
